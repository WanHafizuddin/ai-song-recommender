...
// Closed vocabulary shared by mood extraction and song enrichment so tags
// produced at query time can actually string-match tags stored on songs
// (retrieval filters with `tags && $1`, which needs exact overlap).
const MOOD_TAGS = [
  "aggressive", "anthemic", "atmospheric", "breezy", "calm", "carefree",
  "catchy", "chill", "cinematic", "confident", "dramatic", "dreamy",
  "driving", "dynamic", "emotional", "energetic", "epic", "feel-good",
  "fun", "groovy", "hopeful", "hype", "hypnotic", "intense", "joyful",
  "meditative", "melancholic", "mellow", "nocturnal", "nostalgic",
  "passionate", "peaceful", "powerful", "psychedelic", "rebellious",
  "relaxing", "romantic", "sensual", "sentimental", "serene", "smooth",
  "soothing", "soulful", "theatrical", "upbeat", "vibey", "warm",
];
...
"tags": 2-6 words chosen ONLY from this exact list (pick the closest matches,
do not invent new words): ${MOOD_TAGS.join(", ")}.
Mood: "${safe(moodText)}"`;
...
Return ONLY JSON: {"energy": integer 1-5, "tags": string[]}.
"tags": 3-6 words chosen ONLY from this exact list (pick the closest matches,
do not invent new words): ${MOOD_TAGS.join(", ")}.
...
module.exports = { extractCriteria, rerankSongs, enrichSong, _parseJson, MOOD_TAGS };
